...
% -----------------------------------------------
\begin{frame}
\frametitle<presentation>{Data Management}
  \begin{itemize}
    \item Provide a subset of CMIP5 data: \url{https://cp4cds-index1.ceda.ac.uk/}
    \item Interrogate CP4CDS data web-app: \url{https://cp4cds-qcapp.ceda.ac.uk}
  \end{itemize}
